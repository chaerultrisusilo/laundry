...
if (isset($_POST['save'])) {
    ...
    for ($i = 0; $i < $_POST['countDisplay']; $i++) {
        ...
        $insOrderDet = mysqli_query($koneksi, "INSERT INTO trans_order_detail (id_order, id_service, qty, subtotal, notes) VALUES ('$id_order', '$id_service', '$qty_value', '$subtotal_value', '$notes_value')");
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3 row">
                                <div class="col-sm-3">
                                    <label for="">Code Transaction</label>
                                </div>
                                <div class="col-sm-5">
